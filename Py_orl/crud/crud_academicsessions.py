...
class CRUDAcademicsessions(CRUDBase[AcademicSession, AcademicsessionsCreate, AcademicsessionsUpdate]):
...
academicsessions = CRUDAcademicsessions(AcademicSession)
