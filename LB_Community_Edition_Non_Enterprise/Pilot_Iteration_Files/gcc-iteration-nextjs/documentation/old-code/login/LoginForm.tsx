...
import { getRedirectUrl } from './urlFunctions'
            ...
            <form.Field
              ...
              validators={{
                ...
                onChangeAsync: async ({ value }) => {
                  ...
                  return (
                    value.includes('error') && 'No "error" allowed in API key'
                  )
                },
              }}
              children={(field) => {
                ...
                return (
                  <>
                    <label
                      className={'text-paragraph-p1-semi-bold'}
                      htmlFor={field.name}
                    >
                      API Key
                    </label>
          ...
          <div>
            <form.Field
              ...
              children={(field) => (
                <>
                  <label
                    className={'loginFormSection text-paragraph-p1-semi-bold'}
                    htmlFor={field.name}
                  >
                    School Code
                  </label>
              ...
              children={(field) => (
                <>
                  ...
                  <span className={'text-caption-regular'}>
                    Enter up to 3 Student ID numbers separated by commas
                  </span>
                  <br></br>
                  <input
                    style={{ marginTop: '6px', width: '100%' }}
