...
function AppNavigationBar01({onClickSubMenuLink, selectedMenu, selectedSubMenu}: NEAppNavigationBarProps) {
    ...
    return <div className={`${styles.mainToolbarContainer}`}>
                    ...
                    <Dropdown style={{display: 'inline-block'}}>
                        ...
                        <Dropdown.Menu>
                            ...
                            {selectedMenu !== 'dashboard' ?
                                <Dropdown.Item href="" onClick={() => null}>View Dashboard</Dropdown.Item> : null}
                        </Dropdown.Menu>
                        {selectedMenu === 'dashboard' ? <button disabled={querySaveDisabled}>Save</button> : null}
                    </Dropdown>
                </Nav>
                <Nav>
                    <Form>
                        <InputGroup>
                            <InputGroup.Text id='basic-addon1'><Image src="/menu_search.png" alt="Search" height="20"
                                                                      width="20"/></InputGroup.Text>
                            <Form.Control
                                placeholder='Search'
                                aria-label='Search'
