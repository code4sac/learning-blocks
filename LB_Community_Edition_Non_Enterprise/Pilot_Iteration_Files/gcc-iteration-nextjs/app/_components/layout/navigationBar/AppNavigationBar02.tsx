 ...
 */
function AppNavigationBar02({onClickSubMenuLink, selectedMenu, selectedSubMenu}: NEAppNavigationBarProps) {
        ...
        <Navbar className={`justify-content-between border-bottom`}>
            <Container>
                ...
                <Nav>
                    <Form>
                        <InputGroup>
                            <InputGroup.Text id='basic-addon1'><Image src="/menu_search.png"
                                                                      alt="Search"/></InputGroup.Text>
                            <Form.Control
                                placeholder='Search'
                                aria-label='Search'
