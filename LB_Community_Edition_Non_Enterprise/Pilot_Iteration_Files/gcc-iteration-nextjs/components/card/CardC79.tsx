...
import {parseAnalyticArrowGraphImage} from "@/utils/utils/graph/graphUtils";
 ...
 */
function CardC79({data, selectedCategories, getCardTheme, selectCategory}: AnalyticCardProps) {
    ...
    <Card>
      <Card.Body>
        ...
        <div className={styles.cardBodyImageContainer}>
          <Image src={parseAnalyticArrowGraphImage(data.analyticLevelAmount)} width="120"
