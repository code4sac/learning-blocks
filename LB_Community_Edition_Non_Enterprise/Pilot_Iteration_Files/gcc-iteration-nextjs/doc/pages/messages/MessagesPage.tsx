 ...
 * Contact page.
 */
function MessagesPage({selectedSubMenu}: MessagesPageProps) {
    ...
    return <div>
        <AppContainer02 selectedMenu='messages' selectedSubMenu={currentSubMenu} setCurrentSubMenu={setCurrentSubMenu}>
