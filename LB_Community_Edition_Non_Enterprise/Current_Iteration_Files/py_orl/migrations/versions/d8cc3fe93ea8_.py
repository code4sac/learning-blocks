...
def upgrade() -> None:
    ...
    sa.Column('userSourcedId', sa.String(length=255), nullable=False),
    sa.Column('agentSourcedId', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['agentSourcedId'], ['user.sourcedId'], ),
    sa.ForeignKeyConstraint(['userSourcedId'], ['user.sourcedId'], ),
    sa.PrimaryKeyConstraint('userSourcedId', 'agentSourcedId')
    )
    op.create_table('user_org',
    sa.Column('userSourcedId', sa.String(length=255), nullable=False),
    sa.Column('orgSourcedId', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['orgSourcedId'], ['org.sourcedId'], ),
    sa.ForeignKeyConstraint(['userSourcedId'], ['user.sourcedId'], ),
    sa.PrimaryKeyConstraint('userSourcedId', 'orgSourcedId')
    )
    op.create_table('course',
    sa.Column('sourcedId', sa.String(length=255), nullable=False),
    sa.Column('status', sa.Enum('Active', 'ToBeDeleted', 'Inactive', name='status'), nullable=True),
    sa.Column('dateLastModified', sa.DateTime(), nullable=True),
    sa.Column('schoolYearSourcedId', sa.String(length=255), nullable=True),
    sa.Column('title', sa.String(length=255), nullable=False),
    ...
    sa.Column('schoolSourcedId', sa.String(length=255), nullable=False),
    sa.Column('termSourcedIds', sa.ARRAY(sa.String(length=255)), nullable=False),
    sa.Column('subjects', sa.ARRAY(sa.String(length=255)), nullable=True),
    sa.Column('subjectCodes', sa.ARRAY(sa.String(length=255)), nullable=True),
    ...
    sa.Column('dateLastModified', sa.DateTime(), nullable=True),
    sa.Column('title', sa.String(length=255), nullable=True),
    sa.Column('classSourcedId', sa.String(length=255), nullable=False),
    sa.Column('resourceSourcedId', sa.String(length=255), nullable=False),
    ...
    op.create_table('class_term',
    sa.Column('classSourcedId', sa.String(length=255), nullable=False),
    sa.Column('termSourcedId', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['classSourcedId'], ['class.sourcedId'], ),
    sa.ForeignKeyConstraint(['termSourcedId'], ['academic_session.sourcedId'], ),
    sa.PrimaryKeyConstraint('classSourcedId', 'termSourcedId')
    )
    ...
    sa.Column('classSourcedId', sa.String(length=255), nullable=False),
    sa.Column('categorySourcedId', sa.String(length=255), nullable=False),
    ...
    sa.Column('status', sa.Enum('Active', 'ToBeDeleted', 'Inactive', name='status'), nullable=True),
    sa.Column('dateLastModified', sa.DateTime(), nullable=True),
    sa.Column('lineItemSourcedId', sa.String(length=255), nullable=False),
    sa.Column('studentSourcedId', sa.String(length=255), nullable=False),
